...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL; ?>public/img/logo3.jpeg" alt="" width="50"></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>public/img/logo3.jpeg" alt="LOGO" width="50"></a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner.png">
                            <div class="hero__text">
                                <span>Delicia Express</span>
                                <h2>Gaseosas y mas. <br />100% Confiable</h2>
